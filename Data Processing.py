...
# Merging the data frames using Probe Set ID 
# For CD4 Data
merged_CD4 = CD4_imput.merge(annotation[['Probe Set ID', 'Gene Symbol']], left_index=True, right_on='Probe Set ID', how='left')
...
print(annotated_CD4)
# For CD8 Data
merged_CD8 = CD8_imput.merge(annotation[['Probe Set ID', 'Gene Symbol']], left_index=True, right_on='Probe Set ID', how='left')
...
z_score_data_CD4.to_csv("CD4 Lymphocytes")
z_score_data_CD8.to_csv("CD8 Lymphocytes") 